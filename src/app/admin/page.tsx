          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <div style={{ background: "#0f0f0f", border: "1px solid #1e1e1e", borderRadius: 12, padding: "20px 24px" }}>
              ...
              {runs.slice(0, 8).map((r: any) => (
                <div key={r.id} onClick={() => router.push("/projects/" + r.projectId + "/report?adminView=true&userId=" + (r.triggeredBy || ""))}
              ...
              <tbody>
                {runs.map((r: any) => (
                  <tr key={r.id} style={{ borderBottom: "1px solid #1a1a1a" }}>
                    ...
                    <td style={{ padding: "14px 20px" }}>
                      {r.status === "COMPLETED" && (
                        <button onClick={() => router.push("/projects/" + r.projectId + "/report?adminView=true&userId=" + (r.triggeredBy || ""))}
